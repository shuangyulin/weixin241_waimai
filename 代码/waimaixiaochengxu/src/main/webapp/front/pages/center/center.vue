<template>
    <view class="content">
        <view @tap="onPageTap('../user-info/userinfo')" class="header" v-bind:class="{'status':isH5Plus}"
              :style='{"backgroundColor":"#8E2DE2","height":"200rpx"}'>
            ...
            <view class="setting" :style='{"color":"#A27DE3","fontSize":"40rpx"}'>
        ...
        <view class="list">
              ...
              <view  @tap="onPageTap('../recharge/recharge')"
                     :style='{"backgroundColor":"#A27DE3","borderColor":"#8E2DE2","lineHeight":"80rpx","borderStyle":"solid","borderWidth":"0 0 1rpx  0"}'
